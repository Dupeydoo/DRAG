...
"""
presetchoices (:obj:`tuple` of :obj:`tuple`): A list of available presets to 
use as input to the genetic algorithm.
"""

class PresetForm(forms.Form):
    """
    PresetForm serves as the class for the preset form. Prebuilt tracks can be selected as inputs to the
    genetic algorithm.
